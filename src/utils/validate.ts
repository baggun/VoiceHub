 ...
 */
const characterCountValidate = (value: string, minCount: number, maxCount?: number) => {
  let check = false;
...
export const LoginValidation = ({ id, password }: UserLoginData): UserLoginData => {
...
export const RegisterValidation = ({ id, nickname, email, password }: UserRegisterData): UserRegisterData => {
