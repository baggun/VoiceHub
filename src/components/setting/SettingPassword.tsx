        ...
        <PasswordForm onSubmit={handleSubmit}>
            <div className="form-group">
                ...
                {errors.prev_password && (
                    <ErrorMsg>{errors.prev_password}</ErrorMsg>
                )}
            </div>
            <div className="form-group">
                <AuthInput
                    ...
                    onChange={handleChange}
                />
                {errors.next_password && (
                    <ErrorMsg>{errors.next_password}</ErrorMsg>
                )}
            </div>
            <SubmitButton
                disabled={
                    isLoading ||
                    values.prev_password === "" ||
                    values.next_password === ""
                }
            >
                변경하기
            </SubmitButton>
